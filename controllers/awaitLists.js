...
async function create(req, res, next) {
  ...
  awaitList.save().then((obj) => res.status(200).json({
        msg: "AwaitList almacenado correctamente.",
        obj: obj
      })).catch((ex) => res.status(500).json({
        msg: "No se pudo crear el awaitList.",
        obj: ex
      }));
}
...
function list(req, res, next) {
  ...
  AwaitList.paginate({}, options).then((objs) => res.status(200).json({
        ...
        msg: "No se pudo obtener la lista de espera.",
        obj: ex
      }));
}
...
function index(req, res, next) {
  ...
  AwaitList.findOne({ _id: id }).then((obj) => res.status(200).json({
        msg: `AwaitList con el id ${id}`,
        obj: obj
      })).catch((ex) => res.status(500).json({
        msg: "No se pudo consultar el awaitList.",
        obj: ex
      }));
}
...
function replace(req, res, next) {
  ...
  AwaitList.findOneAndUpdate({ _id: id }, awaitList, { new: true })
    .then((obj) => res.status(200).json({
        msg: "AwaitList remplazado correctamente.",
        obj: obj
      })).catch((ex) => res.status(500).json({
        msg: "No se pudo rempazar el awaitList.",
        obj: ex
      }));
}
...
function update(req, res, next) {
  ...
  AwaitList.findOneAndUpdate({ _id: id }, awaitList)
    .then((obj) => res.status(200).json({
        msg: "AwaitList actualizado correctamente.",
        obj: obj
      })).catch((ex) => res.status(500).json({
        msg: "No se pudo actualizar el awaitList.",
        obj: ex
      }));
}
...
function destroy(req, res, next) {
  ...
  AwaitList.findByIdAndRemove({ _id: id })
    .then((obj) => res.status(200).json({
        msg: "AwaitList eliminado correctamente",
        obj: obj
      })).catch((ex) => res.status(500).json({
        msg: "No se pudo eliminar el awaitList.",
        obj: ex
      }));
}
